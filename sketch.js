...
function preload() {
  video = createVideo("dobrudzhanska.mp4", () => { video.hide(); videoLoaded = true; });
  img = loadImage("dobrudzhanska-colours.png", () => imgLoaded = true);
  icon = loadImage("dobrudzhanska-icon.png", () => iconLoaded = true);
...
function setup() {
  ...
  document.title = "Dobrudzha Region | Folkloric Rhapsody"; 
